        ...
        <nav id="header" class="navbar navbar-expand-md navbar-light bg-white shadow-sm" style="background-size: cover; background-color: blue;">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <!-- Left Side Of Navbar -->
                    <ul class="navbar-nav @guest me-auto @else ms-auto @endguest">
                        ...
                        @guest
                            ...
                            <li class="nav-item {{ Request::is('contactus') ? 'active' : '' }}">
                                <a class="nav-link" style="font-size: 1.3rem; font-weight: bold; color: #002E94"  href="{{ route('contactus') }}">{{ __('Contact Us') }}</a>
                            </li>
                        @else
                            <li class="nav-item {{ Request::is('home') ? 'active' : '' }}">
                                <a class="nav-link" style="font-size: 1.3rem; font-weight: bold; color: #002E94; padding:1rem 2rem;"  href="{{ route('post.index') }}" title="Home">
                            ...
                            <li class="nav-item {{ Request::is('events') ? 'active' : '' }}">
                                <a class="nav-link" style="font-size: 1.3rem; font-weight: bold; color: #002E94; padding:1rem 2rem;"  href="{{ route('post.list_event') }}" title="Events">
                            ...
                            <li class="nav-item {{ Request::is('announcements') ? 'active' : '' }}">
                                <a class="nav-link" style="font-size: 1.3rem; font-weight: bold; color: #002E94; padding:1rem 2rem;"  href="{{ route('post.list_announcements') }}" title="Announcements">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" class="bi bi-megaphone-fill" viewBox="0 0 16 16">
                                        <path d="M13 2.5a1.5 1.5 0 0 1 3 0v11a1.5 1.5 0 0 1-3 0v-11zm-1 .724c-2.067.95-4.539 1.481-7 1.656v6.237a25.222 25.222 0 0 1 1.088.085c2.053.204 4.038.668 5.912 1.56V3.224zm-8 7.841V4.934c-.68.027-1.399.043-2.008.053A2.02 2.02 0 0 0 0 7v2c0 1.106.896 1.996 1.994 2.009a68.14 68.14 0 0 1 .496.008 64 64 0 0 1 1.51.048zm1.39 1.081c.285.021.569.047.85.078l.253 1.69a1 1 0 0 1-.983 1.187h-.548a1 1 0 0 1-.916-.599l-1.314-2.48a65.81 65.81 0 0 1 1.692.064c.327.017.65.037.966.06z"/>
                                    </svg>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link glow-chat-item" style="font-size: 1.3rem; font-weight: bold; color: #002E94; padding:1rem 2rem;"  href="{{ ('/mariteschat') }}" target="_blank" title="Chat">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ route('post.create_get') }}">
                                        {{ __('New Post') }}
                                    </a>
